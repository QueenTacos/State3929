...
function renderHome(el) {
  ...
  el.innerHTML = `
    ...
    <div class="ops-grid">
      ${opCard({
        href: "#/svs", color: "#3B82F6", title: "svs_prep",
      ...
      ${opCard({
        href: "#/feedback", color: "#F97316", title: "feedback",
      ...
      ${opCard({
        href: "#/bears", color: "#3B82F6", title: "bear_calculator",
      ...
      ${
        !Store.currentUser
          ? ""
          : opCard({
              href: "#/alliance", color: "#F97316", title: "alliance_dashboard",
